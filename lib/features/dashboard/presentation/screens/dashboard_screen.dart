...
import 'package:agente_viajes/core/layout/admin_shell.dart';
        ...
        builder: (context, tourState) {
          return BlocBuilder<PagoRealizadoBloc, PagoRealizadoState>(
            builder: (context, pagosState) {
              final tours = tourState is ToursLoaded
                  ? tourState.tours
                  : <Tour>[];
                          ...
                          child: BlocBuilder<CotizacionBloc, CotizacionState>(
                            builder: (context, cotState) {
                              ...
                              return DashStatsGrid(
                                ...
                                onToursTap: () => Navigator.pushNamed(
                                  context,
                                  AppRouter.tours,
                                ),
                                onPromosTap: () => Navigator.pushNamed(
                                  context,
                                  AppRouter.tours,
                                ),
